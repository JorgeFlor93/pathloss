...
public:
  virtual std::vector<double> calcPathloss() override final;
  std::vector<double> areaPathloss(const double top_lat , const double top_lng, const double bot_lat, const double bot_lng, /* Area Corners */
